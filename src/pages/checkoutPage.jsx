                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="bg-light p-30 mb-5">
                            <div className="border-bottom">
                                ...
                                {products && products.map((item, indx) => (
                                    <div className="d-flex justify-content-between mb-2" key={indx}>
                                        <p>{item.title}</p>
                                        <p>{item.quantity}</p>
                        ...
                        <div className="mb-5">
                            ...
                            <div className="bg-light p-30">
                                ...
                                <button className="btn btn-block btn-primary font-weight-bold py-3" disabled={products && products.length ? false : true}>
                                    Place Order
                                </button>
                            </div>
                        </div>
